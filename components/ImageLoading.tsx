...
const LoadingImage: React.FC<LoadingImageProps> = ({ src, alt, width, height, className }) => {
  ...
  return (
    <div className={clsx('relative w-full', className)} style={{ maxWidth: width }}>
      {loading && !error && (
        <div className="absolute inset-0 flex items-center justify-center animate-pulse bg-gray-300 dark:bg-gray-700 z-10">
